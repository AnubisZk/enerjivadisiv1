...
import {
  ...
  ENERGY_VALE_OBJECTS,
  ENERGY_VALE_PROPS,
  ENERGY_VALE_QUEST_ORDER,
  ENERGY_VALE_QUESTS,
} from './content/energy_vale';
...
export const CAMPS: CampDef[] = [
  ...
  // Windwright Vale camps appended LAST so every existing camp keeps its
  // exact world-gen rng draw order (determinism).
  ...ENERGY_VALE_CAMPS,
];
