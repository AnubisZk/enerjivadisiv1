...
export const GROUND_PICKUP_LINES: Record<string, GroundPickupLines> = {
  ...
  survey_post_wind: {
    deny: "The wind gauge spins on, but its readings aren't yours to take yet.",
    enough: 'You have already read the wind survey post.',
  },
  survey_post_sun: {
    deny: "The sun gauge glints, but its readings aren't yours to take yet.",
    enough: 'You have already read the sun survey post.',
  },
  survey_post_steam: {
    deny: "The steam gauge hisses, but its readings aren't yours to take yet.",
    enough: 'You have already read the steam survey post.',
  },
  blade_segment: {
    deny: 'The blade crate is banded shut until Elara asks for its contents.',
    enough: 'You already carry enough mill blade segments.',
  },
  sun_mirror: {
    deny: 'The sun-mirror is locked at its mark; only a windwright errand loosens it.',
    enough: 'Every mirror you were asked to set already stands aligned.',
  },
};
