...
export const pl_PL: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "copper_winding": {
        "name": "Miedziane uzwojenie"
      },
      "blade_segment": {
        "name": "Segment śmigła młyna"
      },
      "survey_post_wind": {
        "name": "Słup pomiaru wiatru"
      },
      "survey_post_sun": {
        "name": "Słup pomiaru słońca"
      },
      "survey_post_steam": {
        "name": "Słup pomiaru pary"
      },
      "sun_mirror": {
        "name": "Zwierciadło słoneczne"
      },
      "fused_slag_core": {
        "name": "Stopiony rdzeń żużlowy"
      },
      "stormtapper_gauntlets": {
        "name": "Pancerne rękawice burzołowcy"
      },
      "stormtapper_mitts": {
        "name": "Mitenki burzołowcy"
      },
      "stormtapper_grips": {
        "name": "Chwyty burzołowcy"
      },
      "skymill_spanner": {
        "name": "Klucz podniebnego młyna"
      },
      "sunmirror_scepter": {
        "name": "Berło słonecznego zwierciadła"
      },
      "coilwound_shiv": {
        "name": "Owinięty szpikulec"
      },
      "stormtappers_charm": {
        "name": "Amulet burzołowcy"
      },
      "stripped_gearwheel": {
        "name": "Starte koło zębate"
      },
      "charged_mote": {
        "name": "Naładowany pyłek"
      },
      "whirl_of_chaff": {
        "name": "Wir plew"
      },
