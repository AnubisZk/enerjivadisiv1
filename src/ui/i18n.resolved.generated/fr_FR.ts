...
export const fr_FR: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "copper_winding": {
        "name": "Bobinage de cuivre"
      },
      "blade_segment": {
        "name": "Segment de pale de moulin"
      },
      "survey_post_wind": {
        "name": "Poteau de relevé du vent"
      },
      "survey_post_sun": {
        "name": "Poteau de relevé du soleil"
      },
      "survey_post_steam": {
        "name": "Poteau de relevé de la vapeur"
      },
      "sun_mirror": {
        "name": "Miroir solaire"
      },
      "fused_slag_core": {
        "name": "Noyau de scories fondues"
      },
      "stormtapper_gauntlets": {
        "name": "Gantelets happe-tempête"
      },
      "stormtapper_mitts": {
        "name": "Mitaines happe-tempête"
      },
      "stormtapper_grips": {
        "name": "Poignes happe-tempête"
      },
      "skymill_spanner": {
        "name": "Clé du moulin céleste"
      },
      "sunmirror_scepter": {
        "name": "Sceptre miroir-soleil"
      },
      "coilwound_shiv": {
        "name": "Surin bobiné"
      },
      "stormtappers_charm": {
        "name": "Charme du happe-tempête"
      },
      "stripped_gearwheel": {
        "name": "Rouage dénudé"
      },
      "charged_mote": {
        "name": "Étincelle chargée"
      },
      "whirl_of_chaff": {
        "name": "Tourbillon de balle"
      },
