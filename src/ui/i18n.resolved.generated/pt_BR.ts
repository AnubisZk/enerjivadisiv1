...
export const pt_BR: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "copper_winding": {
        "name": "Enrolamento de cobre"
      },
      "blade_segment": {
        "name": "Segmento de pá de moinho"
      },
      "survey_post_wind": {
        "name": "Poste de medição do vento"
      },
      "survey_post_sun": {
        "name": "Poste de medição do sol"
      },
      "survey_post_steam": {
        "name": "Poste de medição do vapor"
      },
      "sun_mirror": {
        "name": "Espelho solar"
      },
      "fused_slag_core": {
        "name": "Núcleo de escória fundida"
      },
      "stormtapper_gauntlets": {
        "name": "Manoplas apanha-tormentas"
      },
      "stormtapper_mitts": {
        "name": "Mitenes apanha-tormentas"
      },
      "stormtapper_grips": {
        "name": "Luvas apanha-tormentas"
      },
      "skymill_spanner": {
        "name": "Chave do moinho celeste"
      },
      "sunmirror_scepter": {
        "name": "Cetro espelho-solar"
      },
      "coilwound_shiv": {
        "name": "Estilete enrolado"
      },
      "stormtappers_charm": {
        "name": "Amuleto do apanha-tormentas"
      },
      "stripped_gearwheel": {
        "name": "Engrenagem gasta"
      },
      "charged_mote": {
        "name": "Fagulha carregada"
      },
      "whirl_of_chaff": {
        "name": "Redemoinho de palha"
      },
