...
export const it_IT: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "copper_winding": {
        "name": "Avvolgimento di rame"
      },
      "blade_segment": {
        "name": "Segmento di pala del mulino"
      },
      "survey_post_wind": {
        "name": "Palo di rilevamento del vento"
      },
      "survey_post_sun": {
        "name": "Palo di rilevamento del sole"
      },
      "survey_post_steam": {
        "name": "Palo di rilevamento del vapore"
      },
      "sun_mirror": {
        "name": "Specchio solare"
      },
      "fused_slag_core": {
        "name": "Nucleo di scoria fusa"
      },
      "stormtapper_gauntlets": {
        "name": "Manopole acchiappatempeste"
      },
      "stormtapper_mitts": {
        "name": "Muffole acchiappatempeste"
      },
      "stormtapper_grips": {
        "name": "Prese acchiappatempeste"
      },
      "skymill_spanner": {
        "name": "Chiave del mulino celeste"
      },
      "sunmirror_scepter": {
        "name": "Scettro specchio solare"
      },
      "coilwound_shiv": {
        "name": "Punteruolo avvolto"
      },
      "stormtappers_charm": {
        "name": "Ciondolo dell'acchiappatempeste"
      },
      "stripped_gearwheel": {
        "name": "Ingranaggio spogliato"
      },
      "charged_mote": {
        "name": "Scintilla carica"
      },
      "whirl_of_chaff": {
        "name": "Vortice di pula"
      },
    ...
    "npcs": {
      ...
      "master_windwright_elara": {
        ...
        "greeting": "Mind the cables, {className}. The wind, the sun, the steam under this hill — the vale gives its power freely to anyone patient enough to measure first and build second. Most people skip the measuring. Most people also catch fire."
      }
    },
    "quests": {
      "q_wolves": {
      ...
      "q_ev_survey": {
        ...
        "completion": "A steady norwester on the hill, six clean hours of sun on the flat, and the vent runs hot enough to scald a kettle from ten paces. Three sources, three readings, no guesswork. NOW we can build.",
        "objectives": {
          "0": {
            "label": "Wind Survey Post read"
          },
          "1": {
            "label": "Sun Survey Post read"
          },
          "2": {
            "label": "Steam Survey Post read"
          }
        }
      },
      "q_ev_windings": {
        ...
        "completion": "Bent, chewed, one of them braided into a necklace — but copper is copper, and it'll wind true again. Materials secured. Remember this, {playerName}: half of any build is simply keeping hold of your parts.",
        "objectives": {
          "0": {
            "label": "Coil Scavenger driven off"
          },
          "1": {
            "label": "Copper Winding"
          }
        }
      },
      "q_ev_blades": {
        ...
        "completion": "Four segments, edges true, sockets clean. Balance is everything with a rotor, {playerName} — one warped blade and the whole assembly shakes itself to splinters. These will run smooth.",
        "objectives": {
          "0": {
            "label": "Mill Blade Segment"
          }
        }
      },
      "q_ev_grounding": {
        ...
        "completion": "Quiet lines at last. Say it back to me so I know it stuck: ground first, then touch. The wisps were my mistake, and a builder owns her mistakes — that's how the next site doesn't repeat them.",
        "objectives": {
          "0": {
            "label": "Sparkwisp grounded"
          }
        }
      },
      "q_ev_mirrors": {
        ...
        "completion": "Look at that focus point glow — all four throwing their light to the same spot. That's commissioning, {playerName}: not when it's built, but when it's TUNED. Tomorrow the array boils water by mid-morning.",
        "objectives": {
          "0": {
            "label": "Sun-Mirror aligned"
          }
        }
      },
      "q_ev_overcharge": {
