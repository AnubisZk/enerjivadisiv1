...
const mergeExtraEn = {
  ...
  items: {
    ...
    // Windwright Vale (Energy Vale, REpower educational content)
    copper_winding: { name: 'Copper Winding' },
    blade_segment: { name: 'Mill Blade Segment' },
    survey_post_wind: { name: 'Wind Survey Post' },
    survey_post_sun: { name: 'Sun Survey Post' },
    survey_post_steam: { name: 'Steam Survey Post' },
    sun_mirror: { name: 'Sun-Mirror' },
    fused_slag_core: { name: 'Fused Slag Core' },
    stormtapper_gauntlets: { name: 'Stormtapper Gauntlets' },
    stormtapper_mitts: { name: 'Stormtapper Mitts' },
    stormtapper_grips: { name: 'Stormtapper Grips' },
    skymill_spanner: { name: 'Skymill Spanner' },
    sunmirror_scepter: { name: 'Sunmirror Scepter' },
    coilwound_shiv: { name: 'Coilwound Shiv' },
    stormtappers_charm: { name: "Stormtapper's Charm" },
    stripped_gearwheel: { name: 'Stripped Gearwheel' },
    charged_mote: { name: 'Charged Mote' },
    whirl_of_chaff: { name: 'Whirl of Chaff' },
  },
  mobs: {
    ...mergeNameTranslations(
    DROWNED_MOB_IDS,
    ...
    // Windwright Vale
    coil_scavenger: { name: 'Coil Scavenger' },
    galespun_sprite: { name: 'Galespun Sprite' },
    sparkwisp: { name: 'Sparkwisp' },
    the_overcharge: { name: 'The Overcharge' },
  },
  npcs: {
    tidewatcher_ondrel: {
      name: 'Ondrel Vane',
    ...
    master_windwright_elara: {
      ...
      greeting:
        'Mind the cables, {className}. The wind, the sun, the steam under this hill — the vale gives its power freely to anyone patient enough to measure first and build second. Most people skip the measuring. Most people also catch fire.',
    },
  },
  quests: {
    q_drowned_choir: {
    ...
    q_ev_survey: {
      ...
      objectives: {
        0: { label: 'Wind Survey Post read' },
        1: { label: 'Sun Survey Post read' },
        2: { label: 'Steam Survey Post read' },
      },
    },
    q_ev_windings: {
      title: 'The Missing Windings',
      text: "A mill without its copper windings is a very expensive pinwheel, {playerName}. Kobolds from the old Copper Dig have found my supply crates — they can smell drawn copper through an oak plank. They're camped along the south slope, wearing my coil wire as jewelry. Thin them out and bring back five windings. Every build stands or falls on its supply line.",
      completion:
        "Bent, chewed, one of them braided into a necklace — but copper is copper, and it'll wind true again. Materials secured. Remember this, {playerName}: half of any build is simply keeping hold of your parts.",
      objectives: { 0: { label: 'Coil Scavenger driven off' }, 1: { label: 'Copper Winding' } },
    },
    q_ev_blades: {
      title: 'Blades for the Sky-Mill',
      ...
      completion:
        'Four segments, edges true, sockets clean. Balance is everything with a rotor, {playerName} — one warped blade and the whole assembly shakes itself to splinters. These will run smooth.',
      objectives: { 0: { label: 'Mill Blade Segment' } },
    },
    q_ev_grounding: {
      title: 'Ground the Current',
      text: 'Now the hard lesson, {playerName}: power you cannot ground is power that hunts you. My first mirror test ran current through lines nobody earthed, and the stray charge woke into sparkwisps — live current with a temper, drifting around the array. Put down eight of them before anyone touches another cable. Safety is not the step after the work. It IS the work.',
      completion:
      ...
      objectives: { 0: { label: 'Sparkwisp grounded' } },
    },
    q_ev_mirrors: {
      ...
      completion:
        "Look at that focus point glow — all four throwing their light to the same spot. That's commissioning, {playerName}: not when it's built, but when it's TUNED. Tomorrow the array boils water by mid-morning.",
      objectives: { 0: { label: 'Sun-Mirror aligned' } },
    },
    q_ev_overcharge: {
      title: 'The Overcharge',
      text: "Three sources feeding one site, {playerName}, and I balanced the load for two. The surplus had to go somewhere — and it went into the steamvent, where it's been gathering itself into a thing of fused slag and arc-light. The Overcharge, the diggers call it, and they won't go near the rise. It has to be put down before it walks into my camp, and when it falls, bring me its core: I want to read exactly how the load ran away from me. Take a friend. Faults under full load are not soloed politely.",
      completion:
        "There it is, written in the slag: the surge path, plain as a ledger. I'll split the feed three ways and it won't happen twice. You've seen the whole of it now, {playerName} — survey, supply, assembly, safety, tuning, and the fault at the end that teaches you more than all the rest together. You'd make a fair windwright.",
      objectives: { 0: { label: 'The Overcharge dispersed' }, 1: { label: 'Fused Slag Core' } },
    },
  },
  dungeons: {
    drowned_temple: {
...
mergeExtra.es_ES = mergeExtra.es as typeof mergeExtraEn;
mergeExtra.fr_CA = mergeExtra.fr_FR as typeof mergeExtraEn;
