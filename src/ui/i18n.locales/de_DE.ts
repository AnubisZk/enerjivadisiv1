...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': 'Kupferwicklung',
  'entities.items.blade_segment.name': 'Mühlenflügelsegment',
  'entities.items.survey_post_wind.name': 'Windmesspfosten',
  'entities.items.survey_post_sun.name': 'Sonnenmesspfosten',
  'entities.items.survey_post_steam.name': 'Dampfmesspfosten',
  'entities.items.sun_mirror.name': 'Sonnenspiegel',
  'entities.items.fused_slag_core.name': 'Verschmolzener Schlackenkern',
  'entities.items.stormtapper_gauntlets.name': 'Sturmzapfer-Panzerhandschuhe',
  'entities.items.stormtapper_mitts.name': 'Sturmzapfer-Fäustlinge',
  'entities.items.stormtapper_grips.name': 'Sturmzapfer-Griffe',
  'entities.items.skymill_spanner.name': 'Himmelsmühlen-Schraubenschlüssel',
  'entities.items.sunmirror_scepter.name': 'Sonnenspiegel-Zepter',
  'entities.items.coilwound_shiv.name': 'Drahtgewickelter Stecher',
  'entities.items.stormtappers_charm.name': 'Sturmzapfer-Talisman',
  'entities.items.stripped_gearwheel.name': 'Kahlgedrehtes Zahnrad',
  'entities.items.charged_mote.name': 'Geladener Funke',
  'entities.items.whirl_of_chaff.name': 'Spreuwirbel',
};
