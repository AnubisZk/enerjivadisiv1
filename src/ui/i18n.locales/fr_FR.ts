...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': 'Bobinage de cuivre',
  'entities.items.blade_segment.name': 'Segment de pale de moulin',
  'entities.items.survey_post_wind.name': 'Poteau de relevé du vent',
  'entities.items.survey_post_sun.name': 'Poteau de relevé du soleil',
  'entities.items.survey_post_steam.name': 'Poteau de relevé de la vapeur',
  'entities.items.sun_mirror.name': 'Miroir solaire',
  'entities.items.fused_slag_core.name': 'Noyau de scories fondues',
  'entities.items.stormtapper_gauntlets.name': 'Gantelets happe-tempête',
  'entities.items.stormtapper_mitts.name': 'Mitaines happe-tempête',
  'entities.items.stormtapper_grips.name': 'Poignes happe-tempête',
  'entities.items.skymill_spanner.name': 'Clé du moulin céleste',
  'entities.items.sunmirror_scepter.name': 'Sceptre miroir-soleil',
  'entities.items.coilwound_shiv.name': 'Surin bobiné',
  'entities.items.stormtappers_charm.name': 'Charme du happe-tempête',
  'entities.items.stripped_gearwheel.name': 'Rouage dénudé',
  'entities.items.charged_mote.name': 'Étincelle chargée',
  'entities.items.whirl_of_chaff.name': 'Tourbillon de balle',
};
