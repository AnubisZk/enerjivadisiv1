...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': 'Kopparlindning',
  'entities.items.blade_segment.name': 'Kvarnvingesegment',
  'entities.items.survey_post_wind.name': 'Vindmätarstolpe',
  'entities.items.survey_post_sun.name': 'Solmätarstolpe',
  'entities.items.survey_post_steam.name': 'Ångmätarstolpe',
  'entities.items.sun_mirror.name': 'Solspegel',
  'entities.items.fused_slag_core.name': 'Sammansmält slaggkärna',
  'entities.items.stormtapper_gauntlets.name': 'Stormtappar-stridshandskar',
  'entities.items.stormtapper_mitts.name': 'Stormtappar-vantar',
  'entities.items.stormtapper_grips.name': 'Stormtappar-grepp',
  'entities.items.skymill_spanner.name': 'Himmelskvarnens skiftnyckel',
  'entities.items.sunmirror_scepter.name': 'Solspegelspira',
  'entities.items.coilwound_shiv.name': 'Spolvirad kniv',
  'entities.items.stormtappers_charm.name': 'Stormtapparens amulett',
  'entities.items.stripped_gearwheel.name': 'Nedslitet kugghjul',
  'entities.items.charged_mote.name': 'Laddat stoftkorn',
  'entities.items.whirl_of_chaff.name': 'Agnvirvel',
};
