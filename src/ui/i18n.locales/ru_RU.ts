...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': 'Медная обмотка',
  'entities.items.blade_segment.name': 'Сегмент лопасти мельницы',
  'entities.items.survey_post_wind.name': 'Столб замера ветра',
  'entities.items.survey_post_sun.name': 'Столб замера солнца',
  'entities.items.survey_post_steam.name': 'Столб замера пара',
  'entities.items.sun_mirror.name': 'Солнечное зеркало',
  'entities.items.fused_slag_core.name': 'Сплавленное шлаковое ядро',
  'entities.items.stormtapper_gauntlets.name': 'Латные рукавицы грозолова',
  'entities.items.stormtapper_mitts.name': 'Митенки грозолова',
  'entities.items.stormtapper_grips.name': 'Хваты грозолова',
  'entities.items.skymill_spanner.name': 'Гаечный ключ небесной мельницы',
  'entities.items.sunmirror_scepter.name': 'Скипетр солнечного зеркала',
  'entities.items.coilwound_shiv.name': 'Обмотанная заточка',
  'entities.items.stormtappers_charm.name': 'Оберег грозолова',
  'entities.items.stripped_gearwheel.name': 'Стёртая шестерня',
  'entities.items.charged_mote.name': 'Заряженная искра',
  'entities.items.whirl_of_chaff.name': 'Вихрь мякины',
};
