...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': 'Kobbervikling',
  'entities.items.blade_segment.name': 'Møllevingesegment',
  'entities.items.survey_post_wind.name': 'Vindmålerpæl',
  'entities.items.survey_post_sun.name': 'Solmålerpæl',
  'entities.items.survey_post_steam.name': 'Dampmålerpæl',
  'entities.items.sun_mirror.name': 'Solspejl',
  'entities.items.fused_slag_core.name': 'Sammensmeltet slaggekerne',
  'entities.items.stormtapper_gauntlets.name': 'Stormtapper-kamphandsker',
  'entities.items.stormtapper_mitts.name': 'Stormtapper-vanter',
  'entities.items.stormtapper_grips.name': 'Stormtapper-greb',
  'entities.items.skymill_spanner.name': 'Himmelmøllens skruenøgle',
  'entities.items.sunmirror_scepter.name': 'Solspejlsscepter',
  'entities.items.coilwound_shiv.name': 'Spoleviklet kniv',
  'entities.items.stormtappers_charm.name': 'Stormtapperens amulet',
  'entities.items.stripped_gearwheel.name': 'Nedslidt tandhjul',
  'entities.items.charged_mote.name': 'Ladet støvkorn',
  'entities.items.whirl_of_chaff.name': 'Avnehvirvel',
};
