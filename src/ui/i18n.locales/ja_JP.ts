...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': '銅の巻線',
  'entities.items.blade_segment.name': '風車の羽根部品',
  'entities.items.survey_post_wind.name': '風の観測柱',
  'entities.items.survey_post_sun.name': '太陽の観測柱',
  'entities.items.survey_post_steam.name': '蒸気の観測柱',
  'entities.items.sun_mirror.name': '太陽の鏡',
  'entities.items.fused_slag_core.name': '溶融スラグの核',
  'entities.items.stormtapper_gauntlets.name': 'ストームタッパーのガントレット',
  'entities.items.stormtapper_mitts.name': 'ストームタッパーのミトン',
  'entities.items.stormtapper_grips.name': 'ストームタッパーのグリップ',
  'entities.items.skymill_spanner.name': 'スカイミルのスパナ',
  'entities.items.sunmirror_scepter.name': 'サンミラーの笏',
  'entities.items.coilwound_shiv.name': 'コイル巻きの小刀',
  'entities.items.stormtappers_charm.name': 'ストームタッパーのお守り',
  'entities.items.stripped_gearwheel.name': 'すり減った歯車',
  'entities.items.charged_mote.name': '帯電した塵',
  'entities.items.whirl_of_chaff.name': '籾殻の旋風',
};
