...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': '구리 권선',
  'entities.items.blade_segment.name': '풍차 날개 조각',
  'entities.items.survey_post_wind.name': '바람 측량 기둥',
  'entities.items.survey_post_sun.name': '태양 측량 기둥',
  'entities.items.survey_post_steam.name': '증기 측량 기둥',
  'entities.items.sun_mirror.name': '태양 거울',
  'entities.items.fused_slag_core.name': '융합된 광재 핵',
  'entities.items.stormtapper_gauntlets.name': '폭풍채집자 건틀릿',
  'entities.items.stormtapper_mitts.name': '폭풍채집자 장갑',
  'entities.items.stormtapper_grips.name': '폭풍채집자 가죽장갑',
  'entities.items.skymill_spanner.name': '하늘풍차 스패너',
  'entities.items.sunmirror_scepter.name': '태양거울 홀',
  'entities.items.coilwound_shiv.name': '코일 감긴 단검',
  'entities.items.stormtappers_charm.name': '폭풍채집자의 부적',
  'entities.items.stripped_gearwheel.name': '닳은 톱니바퀴',
  'entities.items.charged_mote.name': '충전된 티끌',
  'entities.items.whirl_of_chaff.name': '겨 회오리',
};
