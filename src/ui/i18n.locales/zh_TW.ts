...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': '銅繞線',
  'entities.items.blade_segment.name': '磨坊葉片段',
  'entities.items.survey_post_wind.name': '測風樁',
  'entities.items.survey_post_sun.name': '測日樁',
  'entities.items.survey_post_steam.name': '測汽樁',
  'entities.items.sun_mirror.name': '聚日鏡',
  'entities.items.fused_slag_core.name': '熔渣核心',
  'entities.items.stormtapper_gauntlets.name': '引雷護手',
  'entities.items.stormtapper_mitts.name': '引雷布手套',
  'entities.items.stormtapper_grips.name': '引雷皮手套',
  'entities.items.skymill_spanner.name': '天磨扳手',
  'entities.items.sunmirror_scepter.name': '日鏡權杖',
  'entities.items.coilwound_shiv.name': '纏線短刃',
  'entities.items.stormtappers_charm.name': '引雷護符',
  'entities.items.stripped_gearwheel.name': '磨禿的齒輪',
  'entities.items.charged_mote.name': '帶電微塵',
  'entities.items.whirl_of_chaff.name': '穀殼旋風',
};
