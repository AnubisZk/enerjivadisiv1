...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.copper_winding.name': '铜绕线',
  'entities.items.blade_segment.name': '磨坊叶片段',
  'entities.items.survey_post_wind.name': '测风桩',
  'entities.items.survey_post_sun.name': '测日桩',
  'entities.items.survey_post_steam.name': '测汽桩',
  'entities.items.sun_mirror.name': '聚日镜',
  'entities.items.fused_slag_core.name': '熔渣核心',
  'entities.items.stormtapper_gauntlets.name': '引雷护手',
  ...
  'entities.items.sunmirror_scepter.name': '日镜权杖',
  'entities.items.coilwound_shiv.name': '缠线短刃',
  'entities.items.stormtappers_charm.name': '引雷护符',
  'entities.items.stripped_gearwheel.name': '磨秃的齿轮',
  'entities.items.charged_mote.name': '带电微尘',
  'entities.items.whirl_of_chaff.name': '谷壳旋风',
};
