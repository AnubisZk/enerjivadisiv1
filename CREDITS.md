...
| Enerji Vadisi pavilion curator NPC (`public/models/chars/npcs/mira_veyr.glb`) | Enerji Vadisi project / Meshy AI-assisted generation | User-provided project asset, optimized for this repository | Project asset |
| Enerji Vadisi secret pocket assets (`public/models/chars/npcs/valley_belle.glb`, `public/models/props/energy_vale/legged_sky_tank.glb`) | Enerji Vadisi project / Meshy AI-assisted generation | User-provided project assets, optimized for this repository | Project asset |
